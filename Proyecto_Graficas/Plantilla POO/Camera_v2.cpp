...
Camera::Camera()
{
	...
	Position = F3dVector(1203.3633, 70.114555, -113.13524);
	cambio = F3dVector (7.4468, 34.211094,300.8448);
...
void Camera::camcam (bool camera1, bool camera2)
{
	if ((camera1==true)&&(camera2==false))
	{
		Position = Position + cambio;
	}

	if ((camera1==false)&&(camera2==true))
	{
		Position = Position - cambio;
	}
